...
var StateNode = (function (_super) {
    ...
    function StateNode(_tree, _parent, path, initialValue, isArray) {
...
var StateTree = (function () {
    function StateTree() {
        this.notifications = [];
        this.subsription = new utils_1.Subscription();
    }
    StateTree.prototype.subscribe = function (subscriber) {
        return this.subsription.subscribe(subscriber);
    };
    StateTree.prototype.unsubscribe = function (iSubscriber) {
