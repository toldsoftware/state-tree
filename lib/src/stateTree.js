...
var StateNode = (function () {
    function StateNode(parent, path, initialValue) {
        this.parent = parent;
        this.path = path;
        this._value = new utils_1.SimpleSubject(null);
    ...
    ;
    StateNode.prototype.setValue = function (v) {
        this._value.emit(v);
    };
    StateNode.prototype.subscribe = function (subscriber) {
        return this._value.subscribe(subscriber);
    };
    StateNode.prototype.unsubscribe = function (iSubscriber) {
